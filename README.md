...
<head>
  ...
  <title>Naufal Nawwar Riadi - Portofolio</title>
  ...
  <style>
    ...
    * {
    ...
    nav h1 { font-size: 22px; color: var(--accent); font-weight: 700; letter-spacing: 1px; }
    nav ul { display: flex; list-style: none; gap: 20px; }
    nav a { color: var(--muted); text-decoration: none; font-weight: 500; transition: 0.3s; }
